...
- 源文件：`Assets/ParadoxNotion/NodeCanvas/Tasks/Conditions/GameObject/CanSeeTarget2D.cs`
...
| `layerMask` | `BBParameter<LayerMask>` | `(LayerMask)( -1 )` | A layer mask to use for the line of sight check. | - |
